...
default_t defaults[] =
{
  ...
  { "dsda_raw_mouse", { &dsda_raw_mouse }, { 0 }, 0, 1, def_bool, ss_stat },
  ...
  // HERETIC_TODO: this causes seg faults - because of dynamic S_music_files I guess
